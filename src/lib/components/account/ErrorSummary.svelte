...
{#if entries.length > 0}
	<div class="border-l-2 border-alert bg-alert/[0.06] px-5 py-4" role="alert" tabindex="-1">
		<p class="text-[11px] tracking-[0.28em] text-forest uppercase font-medium">{title}</p>
		<ul class="mt-3 flex list-none flex-col gap-1.5 p-0 text-[15px] leading-relaxed text-forest/80">
